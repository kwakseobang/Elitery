package com.kwakmunsu.elitery.global.exception.handler;

import com.kwakmunsu.elitery.global.exception.EliteryException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EliteryException.class)
    public ResponseEntity<ResponseData<String>> handleCustomException(EliteryException ex) {
